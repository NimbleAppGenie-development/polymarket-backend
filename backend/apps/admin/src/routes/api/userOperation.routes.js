...
const {
    ...
    deleteQuestion,
    getStaticsCount,
} = require("../../controller/userOperation");
...
router
    ...
    .post(isAuthenticated, upload("category").single("image"), addCategory)
...
router
    ...
    .post(isAuthenticated, upload("category").single("image"), editCategory)
    .all(methodNotAllowed);
