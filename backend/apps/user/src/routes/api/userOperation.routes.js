...
const {userLogin,userRegister,userAccountDetails,addMoney,withdrawMoney,userLogout,getUserPrdicationData,userPrdication,userPortfolio } = require("../../controller/userOperation");
...
router.route("/withdraw-money").post(isAuthenticated,withdrawMoney).all(methodNotAllowed);
